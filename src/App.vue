...
translate:function(){
  var self = this;
 this.axios.get('https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20180312T150548Z.29693a3cf9b19cbf.506398e838f278423b2feaec52eb965ddb983a36&text='+self.TranslateText+'&lang='+self.CurrentLanguage+'-'+self.TranslateLanguage+'&format=plain')
  .then(function (response) {
